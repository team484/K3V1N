...
public class VisionResults {
	public double relativeAngleX, relativeAngleY, inchesX, inchesY, inchesZ, targetRotation = 0.0;
	public boolean targetFound = false;
	
	//Initialized this way when target was found
	public VisionResults(double relativeAngleX, double relativeAngleY, double inchesX, double inchesY, double inchesZ, double targetRotation) {
		...
		this.targetRotation = targetRotation; //The horizontal rotation of the target relative to the robot
